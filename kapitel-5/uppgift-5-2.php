...
<body>
        ...
        if ($namn && $adress && $postnr && $postort ) {
            ...
            if (strlen($postort) < 5) {
             ...
             if (strlen($epost) < 6) {
                echo "<p>E-posten måste vara minst 6 tecken lång</p>";
                 
             }
             if (!strstr($epost, '@')) {
                echo "<p>E-posten måste innehålla @ </p>";

             if (!strstr($epost, '.')) {
                echo "<p>E-posten måste innehålla minst en punkt</p>";
